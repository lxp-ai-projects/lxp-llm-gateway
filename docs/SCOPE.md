...
Public registration also includes tenant-aware email verification through SMTP with short-lived, digest-only challenges. This is deliberately separate from account creation.
