...
- working provider integrations for NanoGPT, OpenRouter, Ollama, Groq, and xAI Grok
...
- additional providers beyond NanoGPT, OpenRouter, Ollama, Groq, and xAI Grok
...
- NanoGPT, OpenRouter, Ollama, Groq, and xAI Grok can be selected transparently through the same gateway contract
