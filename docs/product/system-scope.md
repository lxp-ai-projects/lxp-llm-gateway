...
The public registration foundation can establish email possession for a resolved tenant when tenant registration and global SMTP are enabled. It does not create a user, membership, role, password, or session.
